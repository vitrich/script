...
vitrich5 = [
   ...
   "Лейтеса Марка Филипповича",
   "Мартиросяна Давида Зораковича",
   "Минца Марка Евгеньевича",
   "Молодцова Леонида",
   "Новоженова Юрия Денисовича",
...
for j in names:   
   ...
   for i in range(n):
      a=[randint(0,3),randint(0,2),randint(0,1),choice([1,7,11])]
      b=[randint(0,3),randint(0,2),randint(0,1),choice([1,7,11])]
      c=2**a[0]*3**a[1]*5**a[2]*a[3]
