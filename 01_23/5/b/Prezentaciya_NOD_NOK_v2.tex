...
% Явная загрузка hyperref с отключением unicode
...
\textbf{Проверка:} 12 : 2 = 6, \quad 12 : 3 = 4, \quad 12 : 4 = 3
...
\textbf{\alert{Условие:}} Ткань 48 см $\times$ 40 см режут на квадратные лоскутки. Какой максимальный размер лоскута?
...
$\displaystyle \frac{48}{8} \times \frac{40}{8} = 6 \times 5 = \alert{30}$ лоскутков
...
\begin{itemize}
	...
	\item \textbf{Полезная формула:} НОД(a;b) $\times$ НОК(a;b) = a $\times$ b
\end{itemize}
